...
\begin{figure}[ht]
  \centering
  \subfigure{\includegraphics[width=0.7\textwidth]{tree4.png}}
  \hfill
  \subfigure{\includegraphics[width=0.7\textwidth]{tree5.png}}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.5\textwidth]{ spanningtree.png }
\end{figure}
\pf{Solution}

The Graph has one circuit ($V_2,V_1,V_4,V_2$), and removing any edge of the circuit gives a tree. Thus, as show 
...
\bigbreak \noindent \bigbreak \noindent
\begin{large}
	\textbf{\subsection{Minimum Spanning Trees}} 
\end{large}
\bigbreak \noindent
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.4\textwidth]{ annotated.png }
\caption{}{Graph with distances}
\end{figure}
\bigbreak \noindent
...
\thmcon{
	...
	A \textbf{minimum spanning tree} for a connected, weighted graph is a spanning tree that has the least possible weight compared to all other spanning trees for the graph.
	\bigbreak \noindent
	If $G$ is a weighted graph and $e$ is an edge of $G$, then $w(e)$ denotes the weight of $e$ and \textbf{$w(G)$} denotes the total weight of $G$
}

\pagebreak
\begin{large}
	\textbf{\subsection{Kruskal's Algorithm}} 
\end{large}
\bigbreak \noindent
\thmcon{
	\textbf{\underline{Defintion}}
...
\begin{large}
	\textbf{\subsection{Prim's Algorithm}} 
\end{large}
\bigbreak \noindent
\thmcon{
	\textbf{\underline{Defintion}}
...
\end{figure}
\nt{The black lines shown in the figure create the minimum spanning tree.}
\pagebreak
\begin{center}
	\textbf{Steps for figure 16} 
	\vspace{3mm}

$\begin{array}{|c|l|l|r|}
\hline \text { Iteration Number } & \text { Vertex Added } & \multicolumn{1}{|c|}{\text { Edge Added }} & \text { Weight } \\
\hline 0 & \text { Minneapolis } & & \\
1 & \text { Chicago } & \text { Minneapolis-Chicago } & 355 \\
2 & \text { Milwaukee } & \text { Chicago-Milwaukee } & 74 \\
3 & \text { St. Louis } & \text { Chicago-St. Louis } & 262 \\
4 & \text { Louisville } & \text { St. Louis-Louisville } & 242 \\
5 & \text { Cincinnati } & \text { Louisville-Cincinnati } & 83 \\
6 & \text { Nashville } & \text { Louisville-Nashville } & 151 \\
7 & \text { Detroit } & \text { Cincinnati-Detroit } & 230 \\
\hline
\end{array}$
\end{center}
\bigbreak \noindent \bigbreak \noindent
\begin{large}
	\textbf{\subsection{Dijkstra's Shortest Path Algorithm}}
\end{large}
\bigbreak \noindent
\thmcon{
	\textbf{\underline{Defintion}}
...
\end{figure}
\ex{Actions of Dijkstra's Algorithm}{
	Show the steps in the execution of Dijktra's shortest path algorithm for the graph shown below with starting vertex $a$ and ending vertex $z$
}
\begin{figure}[ht]
\centering
